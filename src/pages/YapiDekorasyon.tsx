        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative h-[500px] lg:h-[600px]">
              ...
              >
                <div className="relative w-full h-full rounded-lg overflow-hidden shadow-2xl shadow-slate-300/60 hover:shadow-slate-400/50 transition-shadow duration-500 group">
                  <img
                    src={interiorLiving}
              ...
              <motion.div
                ...
                className="absolute bottom-[15%] left-0 w-[55%] h-[45%] z-20"
              >
                <div className="relative w-full h-full rounded-lg overflow-hidden shadow-2xl shadow-slate-300/60 hover:shadow-slate-400/50 transition-shadow duration-500 group">
                  <img
                    src={interiorKitchen}
              ...
              <motion.div
                ...
                className="absolute bottom-0 right-[10%] w-[40%] h-[35%] z-30"
              >
                <div className="relative w-full h-full rounded-lg overflow-hidden shadow-2xl shadow-slate-300/60 hover:shadow-slate-400/50 transition-shadow duration-500 group">
                  <img
                    src={interiorBedroom}
                    alt="Zarif yatak odası"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/20 to-transparent" />
                </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 left-[20%] w-20 h-20 border-2 border-slate-200 rounded-full opacity-60"
              />
              <motion.div
                animate={{ y: [0, 10, 0] }}
                transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
                className="absolute bottom-[10%] right-0 w-16 h-16 bg-slate-100 rounded-lg rotate-12"
              />
            </div>
          </div>
        </div>
