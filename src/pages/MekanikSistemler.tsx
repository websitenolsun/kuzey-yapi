...
const MekanikSistemler = () => {
  ...
  const subServiceImages = ["https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=2070&auto=format", "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format", "https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=2070&auto=format", "https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2070&auto=format", "https://images.unsplash.com/photo-1585771724684-38269d6639fd?q=80&w=2070&auto=format", "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?q=80&w=2069&auto=format"];
      ...
      <section className="py-24 bg-gradient-to-t from-[#0a0a0a] to-[#050505] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:+905551234567" className="inline-flex items-center gap-3 bg-[#EAB308] text-black px-12 py-5 rounded-full font-bold tracking-wide transition-all duration-300 hover:bg-[#dca600] hover:shadow-[0_0_40px_-10px_rgba(234,179,8,0.3)] hover:scale-105">
              <Phone size={20} />
