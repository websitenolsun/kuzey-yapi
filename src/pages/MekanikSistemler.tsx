...
import { Wind, Droplets, Flame, Cpu, ArrowRight, Phone, Mail, MessageCircle } from "lucide-react";
...
const MekanikSistemler = () => {
  ...
  const { data: subServices, isLoading } = useSubServices('mekanik');
  ...
  const subServiceImages = [
    ...
    "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2069&auto=format",
    "https://images.unsplash.com/photo-1581094794329-c8112a89af12?q=80&w=2070&auto=format",
    "https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2070&auto=format",
  ...
  return (
    <div className="bg-[#050505] min-h-screen text-white selection:bg-[#EAB308]/30 selection:text-white font-sans pb-0">
      <SEOHead
        title="Mekanik Tesisat Sistemleri"
        description="Endüstriyel ve konut tipi mekanik sistemlerde uçtan uca mühendislik çözümleri. HVAC, sıhhi tesisat, yangın güvenliği ve otomasyon sistemleri."
        canonical="/uzmanliklar/mekanik"
        jsonLd={createServiceSchema(
          "Mekanik Tesisat Sistemleri",
          "Endüstriyel ve konut tipi mekanik sistemlerde uçtan uca mühendislik çözümleri",
          "https://kuzey-yapi.lovable.app/uzmanliklar/mekanik"
        )}
      />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {isLoading ? (
            <div className="space-y-16">
              {[1, 2, 3].map(i => (
                <div key={i} className="h-[400px] bg-[#0a0a0a] animate-pulse rounded-sm"></div>
              ))}
            </div>
          ) : (
