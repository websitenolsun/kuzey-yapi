...
import mekanikProjeYonetimi from "@/assets/mekanik-proje-yonetimi.png";
...
const MekanikSistemler = () => {
  ...
  const subServiceImages = [mekanikIklimlendirme, mekanikSihhiTesisat, mekanikOtomasyon, mekanikProjeYonetimi, yanginTesisati, mekanikIklimlendirme];
