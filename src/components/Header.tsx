      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link to="/" className="flex-shrink-0 flex items-center group cursor-pointer">
          {useFullLogo ? (
            ...
            <img src={kuzeyLogoHorizontal} alt="Kuzey Yapı" className="h-18 w-auto" />
          )}
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <div className={`flex items-center space-x-3 ml-4 pl-4 border-l ${useDarkText ? 'border-gray-300' : 'border-white/20'}`}>
            ...
            {/* Instagram */}
            <SocialIcon href="https://www.instagram.com/kuzey.yapibuderus?igsh=Ym1xYzZhOTJnd3Jp" label="Instagram">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
