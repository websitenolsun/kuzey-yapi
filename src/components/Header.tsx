...
>
  REFERANSLAR
          ...
          <div className="flex items-center space-x-3 ml-4 pl-4 border-l border-white/20">
            ...
            {/* WhatsApp */}
            <SocialIcon href="https://wa.me/905551234567" label="WhatsApp">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col p-8 space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`transition-transform duration-300 ${openMobileDropdown === 'kurumsal' ? 'rotate-180' : ''}`} 
                />
              </button>
              {openMobileDropdown === 'kurumsal' && (
                <div className="space-y-2 pl-4 border-l border-[#D4AF37]/30">
                  <a href="/hakkimizda" className="block text-gray-300 py-1 hover:text-white transition-colors">Hakkımızda</a>
                  <a href="/isg-politikamiz" className="block text-gray-300 py-1 hover:text-white transition-colors">İSG Politikamız</a>
                  <a href="/kalite-politikamiz" className="block text-gray-300 py-1 hover:text-white transition-colors">Kalite Politikamız</a>
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <ChevronDown 
                  size={16} 
                  className={`transition-transform duration-300 ${openMobileDropdown === 'hizmetler' ? 'rotate-180' : ''}`} 
                />
              </button>
              {openMobileDropdown === 'hizmetler' && (
                <div className="space-y-2 pl-4 border-l border-[#D4AF37]/30">
                  <a href="/uzmanliklar/mekanik" className="block text-gray-300 py-1 hover:text-white transition-colors">Mekanik Tesisat</a>
                  <a href="/hizmetler/dogalgaz" className="block text-gray-300 py-1 hover:text-white transition-colors">Doğalgaz Sistemleri</a>
                  <a href="/uzmanliklar/ic-mimari" className="block text-gray-300 py-1 hover:text-white transition-colors">Mimari & Dekorasyon</a>
                  <a href="/hizmetler/elektrik" className="block text-gray-300 py-1 hover:text-white transition-colors">Elektrik Sistemleri</a>
                </div>
              )}
            </div>
